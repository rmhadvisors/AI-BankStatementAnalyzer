...
export const Route = createFileRoute("/analyzing")({
  ...
  head: () => ({ meta: [{ title: "Analyzing - RMH.BSA" }] }),
  component: Analyzing,
});
...
const steps = [
  ...
  "Resolving counterparties, modes and transaction categories...",
  "Computing cash flow, EMI adherence and ABB...",
  "Running bounce, recurring, circular and concentration checks...",
  "Composing underwriting verdict and risk score...",
];
