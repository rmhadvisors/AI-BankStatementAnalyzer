...
/** Repair common OCR word breaks: "PH ONE" → "PHONE", "SERVI CES" → "SERVICES". */
...
/** Cluster key for fuzzy merging of near-duplicate entity names. */
...
/** Merge cluster keys that are very similar (token overlap). */
...
/** Group transactions under canonical party labels (for UI drill-down). */
