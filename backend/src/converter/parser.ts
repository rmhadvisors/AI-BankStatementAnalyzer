...
function extractAccountInfo(lines) {
  ...
  const fields = [
    ["Bank", [/IDFC FIRST BANK/i, /IDFC BANK/i, /IDFC/i, /BANK OF BARODA/i, /HDFC BANK/i, /UNION BANK OF INDIA/i, /IDBI BANK/i], (match) => {
...
function parseStatement(extraction) {
  ...
  // Always prefer calculated totals (derived from parsed transactions)
  // but keep any printed totals available for reference.
